...
MODEL_NAME = "Developer Activity"
WEIGHTS_FILE = "developer_milestone_model/resources/developer_activity_weights.yaml"


class DeveloperActivityMetricsModel(MetricsModel):
            ...
            for date in date_list:
                ...
                observe_contribution_activity_date_dict = self.get_contribution_activity_date_dict((
                                                                                                   ...
                                                                                                   ["star_date_list",
                                                                                                    "fork_date_list",
                                                                                                    "watch_date_list"])
                total_activity_set, freq_casual_set, freq_regular_set, freq_core_set = self.get_freq_contributor_activity_set(
                    date, to_date, contribution_activity_date_dict, observe_contribution_activity_date_dict, period_key)
                type_observe_set = self.get_type_contributor_activity_set(date, to_date,
                                                                          (star_contributor_list +
                                                                           fork_contributor_list +
                                                                           watch_contributor_list),
                                                                          ["star_date_list",
                                                                           "fork_date_list",
                                                                           "watch_date_list"])
                type_observe_star_set = self.get_type_contributor_activity_set(date, to_date, star_contributor_list,
                                                                               ["star_date_list"])
                type_observe_fork_set = self.get_type_contributor_activity_set(date, to_date, fork_contributor_list,
                                                                               ["fork_date_list"])
                type_observe_watch_set = self.get_type_contributor_activity_set(date, to_date, watch_contributor_list,
                                                                                ["watch_date_list"])
                type_issue_set = self.get_type_contributor_activity_set(date, to_date,
                                                                        (issue_creation_contributor_list +
                                                                         issue_comments_contributor_list),
                                                                        ["issue_creation_date_list",
                                                                         "issue_comments_date_list"])
                type_issue_creator_set = self.get_type_contributor_activity_set(date, to_date,
                                                                                issue_creation_contributor_list,
                                                                                ["issue_creation_date_list"])
                type_issue_commenter_set = self.get_type_contributor_activity_set(date, to_date,
                                                                                  issue_comments_contributor_list,
                                                                                  ["issue_comments_date_list"])
                type_code_set = self.get_type_contributor_activity_set(date, to_date,
                                                                       (pr_creation_contributor_list +
                                                                        pr_review_contributor_list +
                                                                        code_commit_contributor_list),
                                                                       ["pr_creation_date_list",
                                                                        "pr_review_date_list",
                                                                        "code_commit_date_list"])
                type_code_author_set = self.get_type_contributor_activity_set(date, to_date,
                                                                              code_commit_contributor_list,
                                                                              ["code_commit_date_list"])
                type_code_pr_creator_set = self.get_type_contributor_activity_set(date, to_date,
                                                                                  pr_creation_contributor_list,
                                                                                  ["pr_creation_date_list"])
                type_code_pr_reviewer_set = self.get_type_contributor_activity_set(date, to_date,
                                                                                   pr_review_contributor_list,
                                                                                   ["pr_review_date_list"])
