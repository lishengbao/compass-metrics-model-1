...
WEIGHTS_FILE = "developer_metrics_model/resources/developer_activity_weights.yaml"
        ...
        for period_key, period_value in self.period_dict.items():
            ...
            for date in date_list:
                ...
                type_observe_set = self.get_type_contributor_activity_set(date, to_date, {
                    ...
                    "fork_date_list": fork_contributor_list,
                    "watch_date_list": watch_contributor_list})
                type_observe_star_set = self.get_type_contributor_activity_set(date, to_date, {
                    "star_date_list": star_contributor_list})
                type_observe_fork_set = self.get_type_contributor_activity_set(date, to_date, {
                    "fork_date_list": fork_contributor_list})
                type_observe_watch_set = self.get_type_contributor_activity_set(date, to_date, {
                    "watch_date_list": watch_contributor_list})
