...
WEIGHTS_FILE = "developer_metrics_model/resources/developer_conversion_weights.yaml"
...
class DeveloperConversionMetricsModel(MetricsModel):
    def __init__(self, json_file=None, from_date=None, end_date=None, out_index=None, community=None, level=None,
        ...
        self.period_conversion_contribution_dict = {}

    def get_freq_contributor_conversion_up_dict(self, from_date, to_date, date_field_contributor_dict, is_bot=False,
                                                period="week"):
        ...
        def get_last_period_conversion_up_dict():
            ...
            casual_regular_up_core_dict = {
                ...
                "ratio": round(len(casual_regular_up_core_set) / len(last_period_activity_casual_regular_set),
                               4) if len(
    ...
    def get_freq_contributor_conversion_down_dict(self, from_date, to_date, date_field_contributor_dict, is_bot=False,
                                                  period="week"):
        ...
        def get_last_period_conversion_down_dict():
            ...
            core_regular_down_casual_dict = {
                ...
                "ratio": round(len(core_regular_down_casual_set) / len(last_period_activity_core_regular_set),
                               4) if len(
    ...
    def get_type_contributor_conversion_dict(self, from_date, to_date, source_date_field_contributor_dict,
                                             to_date_field_contributor_dict,
                                             is_bot=False,
                                             period="week"):
        current_period_activity_set = self.get_type_contributor_activity_set(
            from_date, to_date, to_date_field_contributor_dict, is_bot)

        last_period_from_date = from_date - str_to_offset(self.period_dict[period]["offset"])
        last_period_to_date = from_date
        last_period_activity_set = self.get_type_contributor_activity_set(
            last_period_from_date, last_period_to_date, source_date_field_contributor_dict,
            is_bot)
        retention_dict = {
        ...
        current_date_key = from_date.strftime("%Y-%m-%d")
        period_dict = self.period_conversion_contribution_dict.get(period, {})
        period_dict[current_date_key] = current_period_activity_set | period_dict.get(current_date_key, set())
        self.period_conversion_contribution_dict[period] = period_dict
        return retention_dict

    def get_type_total_contributor_conversion_dict(self, from_date, to_date, source_date_field_contributor_dict,
        ...
        last_period_to_date = from_date
        last_period_activity_set = self.get_type_contributor_activity_set(
            last_period_from_date, last_period_to_date, source_date_field_contributor_dict, is_bot)
        retention_dict = {
        ...
        for period_key, period_value in self.period_dict.items():
            ...
            for date in date_list:
                ...
                before_period_conversion_up_dict = self.get_freq_contributor_conversion_up_dict(
                    date, to_date, date_field_contributor_dict, period=period_key)
                ...
                source_observe_date_field_contributor_dict = {
                    "issue_creation_date_list": issue_creation_contributor_list,
                    "pr_creation_date_list": pr_creation_contributor_list,
                    "issue_comments_date_list": issue_comments_contributor_list,
                    "pr_review_date_list": pr_review_contributor_list,
                ...
                type_observe_dict = self.get_type_contributor_conversion_dict(
                    date, to_date, source_observe_date_field_contributor_dict, {
                        "star_date_list": star_contributor_list,
                        "fork_date_list": fork_contributor_list,
                        "watch_date_list": watch_contributor_list}, period=period_key)
                type_observe_star_dict = self.get_type_contributor_conversion_dict(
                    date, to_date, source_observe_date_field_contributor_dict, {
                        "star_date_list": star_contributor_list}, period=period_key)
                type_observe_fork_dict = self.get_type_contributor_conversion_dict(
                    date, to_date, source_observe_date_field_contributor_dict, {
                        "fork_date_list": fork_contributor_list}, period=period_key)
                type_observe_watch_dict = self.get_type_contributor_conversion_dict(
                    date, to_date, source_observe_date_field_contributor_dict, {
                        "watch_date_list": watch_contributor_list}, period=period_key)

                source_issue_date_field_contributor_dict = {
                    "pr_creation_date_list": pr_creation_contributor_list,
                    "pr_review_date_list": pr_review_contributor_list,
                    "code_commit_date_list": code_commit_contributor_list,
                    "star_date_list": star_contributor_list,
                ...
                type_issue_dict = self.get_type_contributor_conversion_dict(
                    date, to_date, source_issue_date_field_contributor_dict, {
                        "issue_creation_date_list": issue_creation_contributor_list,
                        "issue_comments_date_list": issue_comments_contributor_list}, period=period_key)
                type_issue_creator_dict = self.get_type_contributor_conversion_dict(
                    date, to_date, source_issue_date_field_contributor_dict, {
                        "issue_creation_date_list": issue_creation_contributor_list}, period=period_key)
                type_issue_commenter_dict = self.get_type_contributor_conversion_dict(
                    date, to_date, source_issue_date_field_contributor_dict, {
                        "issue_comments_date_list": issue_comments_contributor_list}, period=period_key)

                source_code_date_field_contributor_dict = {
                    "issue_creation_date_list": issue_creation_contributor_list,
                    "issue_comments_date_list": issue_comments_contributor_list,
                    "star_date_list": star_contributor_list,
                    "fork_date_list": fork_contributor_list,
                ...
                type_code_dict = self.get_type_contributor_conversion_dict(
                    date, to_date, source_code_date_field_contributor_dict, {
                        "pr_creation_date_list": pr_creation_contributor_list,
                        "pr_review_date_list": pr_review_contributor_list,
                        "code_commit_date_list": code_commit_contributor_list}, period=period_key)
                type_code_author_dict = self.get_type_contributor_conversion_dict(
                    date, to_date, source_code_date_field_contributor_dict, {
                        "code_commit_date_list": code_commit_contributor_list}, period=period_key)
                type_code_pr_creator_dict = self.get_type_contributor_conversion_dict(
                    date, to_date, source_code_date_field_contributor_dict, {
                        "pr_creation_date_list": pr_creation_contributor_list}, period=period_key)
                type_code_pr_reviewer_dict = self.get_type_contributor_conversion_dict(
                    date, to_date, source_code_date_field_contributor_dict, {
                         "pr_review_date_list": pr_review_contributor_list}, period=period_key)
                type_total_dict = self.get_type_total_contributor_conversion_dict(
                    date, to_date,date_field_contributor_dict, period=period_key)
